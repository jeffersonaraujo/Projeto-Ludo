...
/**
 * Classe CasaRepete é a classe que herda de Classe e tem um comportamento para
 * executar.
 *
 ...
 */
public class CasaRepete extends Casa implements Strategy {

    public CasaRepete(String id, String nomeCasa, String param) {
