...
/**
 * Classe CasaAvanca é a classe que herda de Classe e tem um comportamento para
 * executar.
 *
 ...
 */
public class CasaAvanca extends Casa implements Strategy {

    public CasaAvanca(String id, String nomeCasa, String param) {
