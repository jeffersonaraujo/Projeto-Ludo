...
/**
 * Classe CasaFim é a classe que herda de Classe e tem um comportamento para
 * executar.
 *
 ...
 */
public class CasaFim extends Casa implements Strategy {

    public CasaFim(String id, String nomeCasa, String param) {
