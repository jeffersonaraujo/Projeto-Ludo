...
/**
 * Classe CasaPara é a classe que herda de Classe e tem um comportamento para
 * executar.
 *
 ...
 */
public class CasaPara extends Casa implements Strategy {

    public CasaPara(String id, String nomeCasa, String param) {
